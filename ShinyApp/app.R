                                                  ...
                                                  mainPanel(
                                                   fluidRow(
                                                     ...
                                                     column(3, 
                                                            ...
                                                            numericInput("Lv", "Length",14.7646875),
                                                            
                                                            numericInput("Vv", "Velocity", 0.122857846019418),
                                                            
                                                            numericInput("Dv", "Diffusion", 0),
                                                            
                                                            numericInput("Fv", "Flow Rate",0)),
                                                     column(3, offset=0.25, style="border-right: 3px solid black;
                                                            height: 300px;",
                                                     ...
                                                     column(3, offset=0.5, 
                                                            ...
                                                            numericInput("Qv", "Concentration", 1300),

                                                            numericInput("rbv", "Bead Radius", 0.03375),

                                                            numericInput("EBEDv", "Bed Porosity", 0.35)),

                                                     column(3, offset=1.25,
                                                            selectInput("qunits", "", c("meq/L")),
                                                            selectInput("rbunits", "", c("cm", "m", "mm", "in", "ft")),
                                                            selectInput("EBEDunits", "", c(""))),
                                                     # column(2, offset=1.5, 
                                                     #        
                                                     #        numericInput("kLv", "Film Transfer Coefficient",0.0021),
                                                     #        
                                                     #        numericInput("Dsv", "Surface Diffusion Coefficient",0.0000002)),
                                                     # column(2, offset=1.75,
